...
## 🏝️Intro: 서비스 소개
**Maronnier**는 술을 사랑하는, 또는 술에 대해 잘 모르는 사람들을 위한 취향 기반 술 추천 서비스입니다.<br>
몇 가지 질문을 통해 자신의 취향에 맞는 술을 찾고, 피드 게시판에서 유저 간 각자의 술 경험을 공유할 수 있습니다.

### ⭐️ Feat: 주요 기능 소개

#### 1) 칵테일 추천 기능
유저가 무엇을 마시고 싶은지 모를 때, 또는 가장 본인에게 적합한 술을 찾기 위해 술 추천 기능을 사용할 수 있습니다.<br>
몇 가지 질문을 통해 유저에게 근접한 술을 추천해주며, 술 제조법과 재료 정보를 알 수 있습니다.

#### 2) 피드
유저의 술 장바구니에 담긴 술들을 유저가 리뷰하고 해당 술을 끌어다가 새로운 내용들을 작성할 수 있습니다.<br>
이를 통해 유저들간의 새로운 제조법과 다양한 팁과 정보들을 알 수 있습니다.

#### 3) 취향 기반 술 추천 서비스
쌓여온 DB를 통해, 자신의 취향에 맞는 술을 자동으로 추천해 주는 서비스입니다.

#### 4) 칵테일 요청글 및 신고
사용자는 궁금한 술 제조법 등을 요청할 수 있으며, 신고 기능을 통해 부적절한 피드를 비공개 처리할 수 있습니다.

### 📅 **프로젝트 기간** : 2023.07.07 ~ 2023.07.30 (약 24일)
